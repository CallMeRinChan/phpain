...
if (isset($_GET['gokje'])) {
  if($_GET['gokje']==$woord6) {
  $ant6 = $woord6;
$gekozen = $_GET['gekozen'].$_GET['gokje'];
}
}
if (isset($_GET['gokje'])) {
  if($_GET['gokje']==$woord7) {
  $ant7 = $woord7;
}
$gekozen = $_GET['gekozen'].$_GET['gokje'];
}
 ?>
    ...
    <br/>
     <?php echo $ant1 . " " . $ant2 . " " . $ant3 . " " . $ant4 . " " . $ant5 . " " . $ant6 . " " . $ant7; ?>
    <br/><br/>
    <form action="les2.php" method="get">
      ...
      <input type="hidden" name="ant6" value="<?php echo $ant6 ?>">
      <input type="hidden" name="ant7" value="<?php echo $ant7 ?>">
      <input type="hidden" name="gekozen" value="<?php echo $gekozen; ?>"/>
      <input type="submit" value = "Click me daddy!"/>
    </form>

<?php
  echo "Je hebt " . strlen($gekozen) . " pogingen gedaan";
?>
<br/>
<?php
  if(($ant1 == $woord1) && ($ant2 == $woord2) && ($ant3 == $woord3) && ($ant4 == $woord4) && ($ant5 == $woord5) && ($ant6 == $woord6) && ($ant7 == $woord7)){
    ?>
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrUpjs-mnJJi38zcDjROIB8JBLpzImo45kZvquzrfphCvE1w_sIOJSMKyEugXgDR5Vszw&usqp=CAU"/>
    <?php
  }
?>
